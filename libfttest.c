...
/*   Updated: 2014/11/07 17:31:45 by celegran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int                                     uf_test_strtrim(void)
{
        ...
        free (r);
        r = ft_strtrim(str4);
        if (strcmp(r, "test") || (str4 == r))
        {
                printf("\033[31mft_strstrim(\"   test   \").\nExpected ret = \"test\" and different\
                                s pointers but have ret = \"%s\" and our: %p / your: %p\033[0m\n", r, str4, r);
                free(r);
                return (0);
        }
        free(r);
        r = ft_strtrim(str5);
        if (strcmp(r, "t t") || (str5 == r))
        {
                printf("\033[31mft_strstrim(\"   test   \").\nExpected ret = \"t t\" and different\
                                s pointers but have ret = \"%s\" and our: %p / your: %p\033[0m\n", r, str4, r);
                free(r);
                return (0);
        }
